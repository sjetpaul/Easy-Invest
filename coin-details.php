    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="coin-details.php?coin=<?php echo $coin["symbol"]; ?>" class="active"><?php echo $coin['id']; ?></a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  ...
                  if (Array.isArray(rawData) && rawData.length) {
                    ...
                    document.getElementById("chart").innerHTML="<h1 class='text-center'>Chart Data Not Available!!!</h1>";
                  }
                })
              </script>
              <!-- End Chart -->
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="<?php
                                  $coin_change_new = round($coin['price_change_percentage_24h'], 2);
                                  echo  $coin_change_new > 0 ? "text-success" : "text-danger";
                                  ?> small pt-1 fw-bold">

                      <?php
                      echo   $coin_change_new; ?>
                      %
                    </span>
                    <span class="text-muted small pt-2 ps-1">
                      <?php
                      echo ($coin_change_new > 0) ? "<b> increase </b>" : "<b> decrease </b>";
                      ?>
                    </span>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    <h6><?php
                        ...
                        //  echo $coin['market_cap'];


                        ?></h6>
                    <span class="<?php
                                  $coin_market_cap_new = round($coin['market_cap_change_percentage_24h'], 2);
                                  echo ($coin_market_cap_new > 0) ? "text-success" : "text-danger";
                                  ?> small pt-1 fw-bold">
                      <?php
                      echo $coin_market_cap_new;
                      ?>%</span> <span class="text-muted small pt-2 ps-1">
                      <?php
                      echo ($coin_market_cap_new > 0) ? " <b>increase </b>" : "<b>decrease</b>";
                      ?></span>
