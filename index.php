<?php
// Add Coin Symbols you want to Search for
...
<head>
  ...
  <title>Easy Invest - Next Move To Investment</title>
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><img src="assets/img/logo.png" alt=""> Easy Invest</a></h1>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="index/assets/img/hero-img.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid" data-aos="fade-up">
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper">
            ...
            ?>
              <div class="swiper-slide"><a href="<?php echo  $value["image"]; ?>" class="gallery-lightbox" data-gall="gallery-carousel"><img src="<?php echo  $value["image"]; ?>" class="img-fluid" alt=""></a></div>
            <?php
            }
            ?>
          </div>
  ...
  <footer id="footer">
    <div class="container py-4">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://easyinvest.store/">Easy Invest</a>
      </div>
    </div>
  </footer><!-- End Footer -->
