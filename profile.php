      ...
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <img src="<?php echo $val['image_url']; ?>" alt="profile" onerror="this.src='images/profile.png';">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <div class="row mb-3">
                      ...
                      <img src="<?php echo $val['image_url']; ?>" alt="profile" onerror="this.src='images/profile.png';">
                       ...
                       <button type="submit" name="delete_img" class="btn btn-danger btn-sm" title="Remove my profile image" onClick="window.location.reload(true);"><i class="bi bi-trash"></i></button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-primary" name="edit_profile" onClick="history.go(0);" >Save Changes</button>
                    </div>
